    ...
    <div class="row">
        <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
            <div class="form-group">
                <label for="">Folio de Prventa</label>
        ...
        <table id="detalles" class="table table-striped table-bordered table-condensed table-hover">
            ...
            <tfoot>
                ...
                <tr>
                    ...
                    <th>
                        <div class="input-group">
                            <input type="text" class="form-control-sm" name="subdesc" id="desctotal">
                        </div>
                    </th>
                </tr>
                <tr>
                    ...
                    <th>
                        <div class="input-group">
                            <input type="text" class="form-control-sm" name="impuestos" id="impuestos">                            
                        </div>
                        @error('impuestos')
                    ...
                    <th>
                        <div class="input-group">
                            <input type="text" class="form-control-sm" placeholder="00.00" name="total" id="total">
                        </div>
                    </th>
                </tr>
                <tr>
